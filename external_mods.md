...
| :--- | :--- | :--- | :--- | :--- |
| `3d_armor` | stu | LGPL-2.1-only | [ContentDB](https://content.luanti.org/packages/stu/3d_armor/) &bull; [Source](https://github.com/minetest-mods/3d_armor) |  |
...
| `motorboat` | apercy | MIT | [ContentDB](https://content.luanti.org/packages/apercy/motorboat/) &bull; [Source](https://github.com/APercy/motorboat) |  |
...
| `torch_bomb` | FaceDeer | MIT for code, CC-BY-SA-3.0 for media | [ContentDB](https://content.luanti.org/packages/FaceDeer/torch_bomb/) &bull; [Source](https://github.com/minetest-mods/torch_bomb) |  |
| `travelnet` | mt-mods | GPL-3.0-only for code, CC0-1.0 for media | [ContentDB](https://content.luanti.org/packages/mt-mods/travelnet/) &bull; [Source](https://github.com/mt-mods/travelnet) |  |
| `tt` | Wuzzy | MIT | [ContentDB](https://content.luanti.org/packages/Wuzzy/tt/) &bull; [Source](https://codeberg.org/Wuzzy/minetest_tt) |  |
...
| `xdecor` | Wuzzy | BSD-3-Clause for code, CC-BY-4.0 for media | [ContentDB](https://content.luanti.org/packages/Wuzzy/xdecor/) &bull; [Source](https://codeberg.org/Wuzzy/xdecor-libre) |  |
