...
function motorcycle.attach_driver_stand(self, player)
    ...
    if automobiles_lib.mot_anim_mode then
        ...
        local left_leg_override = {
                ...
                rotation = { vec={x=math.rad(12),y=0,z=math.rad(-10)}, interpolation = 1, absolute = false }
                }
    ...
    if self._passenger == nil then
        ...
        if automobiles_lib.mot_anim_mode then
            ...
            local left_arm_override = {
                    ...
                    rotation = { vec={x=math.rad(45),y=0,z=math.rad(10)}, interpolation = 1, absolute = false }
                    }
