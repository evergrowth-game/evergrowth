...
local raw_loot_categories = {
	supplies = {
		...
		{name = "death_compass:compass", min = 1, max = 1, weight = 2},
	...
	food = {
		...
		{name = "farming:wheat_seed", min = 2, max = 8, weight = 14},
		{name = "farming:seed_cotton", min = 2, max = 6, weight = 10},
		{name = "farming:seed_tomato", min = 1, max = 4, weight = 8},
		{name = "farming:seed_cucumber", min = 1, max = 4, weight = 8},
		{name = "farming:seed_potato", min = 1, max = 4, weight = 8},
		{name = "cheese:cheese_slice", min = 1, max = 4, weight = 6},
	},
	ores_shallow = {
	...
	tools_shallow = {
		...
		{name = "3d_armor:shield_wood", weight = 5, is_tool = true},
	},
	tools_deep = {
		...
		{name = "3d_armor:shield_steel", weight = 8, is_tool = true},
		{name = "3d_armor:shield_bronze", weight = 6, is_tool = true},
		{name = "3d_armor:helmet_bronze", weight = 6, is_tool = true},
	},
	relics_magic = {
		{name = "magic_materials:mana_crystal", min = 1, max = 3, weight = 15},
		{name = "magic_materials:magic_stick", min = 1, max = 1, weight = 8},
		{name = "magic_materials:rune_unformed", min = 1, max = 2, weight = 10},
		{name = "magic_materials:rune_ignis", min = 1, max = 1, weight = 6},
		{name = "magic_materials:rune_aqua", min = 1, max = 1, weight = 6},
		{name = "magic_materials:rune_terra", min = 1, max = 1, weight = 6},
		{name = "magic_materials:rune_aer", min = 1, max = 1, weight = 6},
		{name = "magic_materials:rune_ordo", min = 1, max = 1, weight = 4},
		{name = "magic_materials:rune_perditio", min = 1, max = 4, weight = 4},
