...
if space_enabled then
	...
	-- Inert registration to avoid Unknown Item in pre-existing saves
	minetest.register_craftitem("other_worlds_tweaks:derelict_scanner", {
		description = "Subspace Distress Scanner (Space Exploration Disabled)",
		inventory_image = "jumpdrive_warpdevice.png^[colorize:#a855f7:140",
		stack_max = 16,
	})

	minetest.log("action", "[other_worlds_tweaks] Space exploration disabled: registered base nodes and inert scanner stub.")
end
