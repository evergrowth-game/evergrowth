...
minetest.log("action", "[other_worlds_tweaks] Loaded space worldgen tweaks, rich ores, gravity monoids, climate hooks, asteroid mapgen, space derelicts, orbital solar power, and water-fed electrolyzer ISRU hook.")
