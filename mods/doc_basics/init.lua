...
{
	name = S("Basics"),
	description = S("Everything you need to know about Luanti to get started with playing"),
	sorting = "custom",
...
doc.add_category("advanced",
{
	...
	description = S("Advanced information about Luanti which may be nice to know, but is not crucial to gameplay"),
	sorting = "custom",
...
S("• Use a crafting guide mod to learn crafting recipes or visit <@1>", "https://wiki.luanti.org/wiki/Crafting").."\n"..
...
doc.add_entry("basics", "minetest", {
	...
	data = {
		text =
S("Luanti is a free software game engine for games based on voxel gameplay, inspired by InfiniMiner, Minecraft, and the like. Luanti was originally created by Perttu Ahola (alias “celeron55”).").."\n\n"..

S("The player is thrown into a huge world made out of cubes or blocks. These cubes usually make the landscape they blocks can be removed and placed almost entirely freely. Using the collected items, new tools and other items can be crafted. Games in Luanti can, however, be much more complex than this.").."\n\n"..

S("A core feature of Luanti is the built-in modding capability. Mods modify existing gameplay. They can be as simple as adding a few decorative blocks or be very complex by e.g. introducing completely new gameplay concepts, generating a completely different kind of world, and many other things.").."\n\n"..
...
S("Games for Luanti can be downloaded from within the Luanti application via the “Content” tab or the ContentDB website <@1>.", "https://content.luanti.org/"),
...
S("The minimap may not always be available; games may either disable it entirely or they require you to do something to “unlock” the minimap (like carrying a map item).").."\n\n"..
...
S("Official homepage of Luanti: <@1>", "https://luanti.org").."\n"..
S("The main place to find the most recent version of Luanti.").."\n\n"..

S("Community wiki: <@1>", "https://wiki.luanti.org").."\n"..
S("A community-based documentation website for Luanti. Anyone with an account can edit it!").."\n\n"..

S("Web forums: <@1>", "https://forum.luanti.org").."\n"..
