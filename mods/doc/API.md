...
of a category (“Entry” tab). If the entry is hidden, the formspec
will display an error message instead unless `ignore_hidden==true`.
If the entry or category does not actually exist, the formspec
will show another error message to the player.
