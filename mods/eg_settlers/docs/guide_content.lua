...
local chapters = {
	{
		id = "intro",
		title = "Introduction to Settlements",
	...
	{
		id = "contracts",
		title = "Hiring Contracts & Workstations",
	...
	{
		id = "jobs",
		title = "Job Board & Passive Income",
	...
	{
		id = "defenses",
		title = "Town Defenses & Medical Care",
	...
	{
		id = "justice",
		title = "Law, Justice & Territory Protection",
