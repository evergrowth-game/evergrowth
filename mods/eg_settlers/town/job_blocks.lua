...
eg_settlers.register_job_block("guard", {
    description = "Guard's Armory Stand",
    cost = 8,
...
eg_settlers.register_job_block("lumberjack", {
    ...
    selection_box = { type = "fixed", fixed = {-0.45, -0.5, -0.45, 0.45, 0.75, 0.45} },
    collision_box = { type = "fixed", fixed = {-0.45, -0.5, -0.45, 0.45, 0.75, 0.45} },
})
