...
mobs:register_mob("raiders:plundererflask", {
	-- animal, monster, npc
	type = "monster",
...
mobs:register_egg("raiders:plundererflask", S"Plunderer with Flask", "aplundererflask.png")

mobs:register_arrow("raiders:flask", {
	visual = "sprite",
	visual_size = {x=.5, y=.5},
	textures = {"flask.png"},
	velocity = 12,
