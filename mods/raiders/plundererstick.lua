...
mobs:register_mob("raiders:plundererstick", {
	type = "monster",
	passive = false,
	step_height = 2,
	fear_height = 4,
...
mobs:register_egg("raiders:plundererstick", S("Plunderer with a Stick"), "aplundererstick.png")
