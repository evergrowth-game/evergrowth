...
lucky_block:add_blocks({
	...
	{"nod", "default:chest", 0, {
		{name = "farming:corn", max = 5},
		{name = "farming:kiwi", max = 5},
		{name = "farming:beans", max = 5},
		{name = "farming:onion", max = 5},
		{name = "farming:carrot", max = 5},
		{name = "farming:garlic_clove", max = 5},
		{name = "farming:ginger", max = 5},
		{name = "farming:grapes", max = 5},
		{name = "farming:pepper", max = 5},
		{name = "farming:potato", max = 5},
		{name = "farming:tomato", max = 5},
		{name = "farming:lettuce", max = 5},
		{name = "farming:cabbage", max = 5},
		{name = "farming:parsley", max = 5},
		{name = "farming:peas", max = 5},
		{name = "farming:rhubarb", max = 5},
		{name = "farming:soy_pod", max = 5},
		{name = "farming:spinach", max = 5},
		{name = "farming:vanilla", max = 5},
		{name = "farming:cucumber", max = 5},
		{name = "farming:eggplant", max = 5},
		{name = "farming:artichoke", max = 5},
		{name = "farming:asparagus", max = 5},
		{name = "farming:pineapple", max = 5},
		{name = "farming:sunflower", max = 5},
		{name = "farming:blackberry", max = 5},
		{name = "farming:blueberries", max = 5},
		{name = "farming:melon_slice", max = 5},
		{name = "farming:chili_pepper", max = 5},
		{name = "farming:coffee_beans", max = 5},
		{name = "farming:pumpkin_slice", max = 5},
		{name = "ethereal:strawberry", max = 5},
	}}
})
